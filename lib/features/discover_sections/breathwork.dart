  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.green.shade400, // Updated color for AppBar
      ),
      body: Container(
  ...
  Widget _buildPlaylistItem({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon, color: Colors.green.shade400, size: 40), // Green icon color
            const SizedBox(width: 10),
            Expanded(
              child: Text(
                title,
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.green.shade600), // Text color changed to a darker green
              ),
            ),
            ElevatedButton(
              onPressed: () {
